...
const Login: React.FC = () => {
  ...
  return (
    <Form
      ...
      {...formConfig}
      onFinish={() => onLogin()}
      // onFinish={() => onAuthPostData(endpoints.auth.login, state.request)}
      fields={[
        {
          name: "email",
    ...
    >
      ...
      <div className="flex items-center justify-end">
        <p
          className="text-[#333333] text-base font-[gilroy-medium] font-normal mt-[-1rem] cursor-pointer underline mb-4"
          onClick={() => {
      ...
      {/* <div className="flex items-center justify-between w-full my-5">
        ...
        <p className="w-full text-center text-[#333333] font-normal sm:text-base text-xs font-[gilroy-regular]">
          Or continue with
        </p>
        <hr className="w-full border border-[#E3E6EA]" />
      </div>
